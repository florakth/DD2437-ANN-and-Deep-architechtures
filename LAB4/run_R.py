...
from dbn_reduced_layer import DeepBeliefNet_R
...
if __name__ == "__main__":
    ...
    print ("\nStarting a reduced Deep Belief Net..")
    
    dbn = DeepBeliefNet_R(sizes={"vis":image_size[0]*image_size[1], "hid":500, "top":2000, "lbl":10},
                        image_size=image_size,
                        n_labels=10,
                        batch_size=200
    )
    ...
    for digit in range(10):
        ...
        dbn.generate(digit_1hot, name="rbms_r")
    ...
    for digit in range(10):
        digit_1hot = np.zeros(shape=(1,10))
        digit_1hot[0,digit] = 1
        dbn.generate(digit_1hot, name="dbn_r")
